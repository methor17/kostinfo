...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Selamat datang di RentKost</title>
...
<?php } ?>
				...
				<li <?php if ($_GET['pemilik'] == 'index') echo 'class="selected"' ?>><a href="pemilik/index.php">pemilik</a></li>
				<li <?php if ($_GET['admin'] == 'index') echo 'class="selected"' ?>><a href="admin/index.php">Admin</a></li> 
<?php if ($aktif) { ?>
                    <li <?php if ($_GET['pages'] == 'profile') echo 'class="selected"' ?>><a href="?pages=profile">Profil User</a></li>		
                    <li><a href="action/logout.php">Logout</a></li>		
                <?php } else { ?>
                    <li><a href="?pages=login">User</a></li>		
<?php } ?>
            </ul>
            <div class="logo"><a href="index.php"><img src="images/logo.gif" alt="" /></a></div>
        </div>
        <div id="body">
            <?php
            if (!empty($_GET['pages'])) {
        ...
        <div id="footer">
            <div>
                <p><h2 align="center"><img src="images/footer.gif" width="243" height="39"><br>
                  <span class="style3">Powered By InfoKosan ATOL7@2018 </span></h2>
          </div>
        </div>
    </body>
</html>